package com.sparta.clonecoding_unite_00.favorite.refactoring;
...
@Component
public class FavoriteRefactoring {
    ...
    public ResponseDto<?> getFavoriteMethod(HttpServletRequest request){
    ...
    public ResponseDto<?> favoriteAddMethod(Long movieId,HttpServletRequest request){
