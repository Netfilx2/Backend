package com.sparta.clonecoding_unite_00.likes.refactoring;
...
public class LikesRefactoring {
    ...
    public ResponseDto<?> addLikeRefactoring(Long movieId, HttpServletRequest request){
